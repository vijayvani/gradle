...
You can take a look at what you needed to do with Gradle versions up to 6.6 https://docs.gradle.org/6.6.1/userguide/building_java_projects.html#compiling_and_testing_java_67[here].
